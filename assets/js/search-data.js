...
ninja.data = [{
    ...
    handler: () => {
      window.location.href = "/";
          ...
          section: "Navigation",
          handler: () => {
            window.location.href = "/assets/pdf/marashian_cv.pdf";
          },
        },{id: "nav-teaching",
          title: "teaching",
        ...
        section: 'Socials',
        handler: () => {
          window.open("https://www.linkedin.com/in/ali-marashian", "_blank");
        },
      },{
        id: 'social-rss',
        title: 'RSS Feed',
        ...
        section: 'Socials',
        handler: () => {
          window.open("https://scholar.google.com/citations?user=jEHAaOYAAAAJ", "_blank");
        },
      },{
      id: 'light-theme',
